...
class App_Banners_Admin {
	...
	public static function register() {
		...
		register_setting( APP_BANNERS_ID . '_options', 'APP_BANNERS_appendToSelector' );
		register_setting( APP_BANNERS_ID . '_options', 'APP_BANNERS_printViewPort' );
		register_setting( APP_BANNERS_ID . '_options', 'APP_BANNERS_pushSelector' );
	}

	public static function menu() {
		// Create menu tab
		add_options_page( APP_BANNERS_NICK . ' Plugin Options', APP_BANNERS_NICK, 'manage_options', APP_BANNERS_ID . '_options', array(
			'App_Banners_Admin',
			'options_page'
		) );
	}
	...
	public static function options_page() {
		...
		$appendToSelector         = get_option( 'APP_BANNERS_appendToSelector' );
		$printViewPort            = get_option( 'APP_BANNERS_printViewPort', true );
		$pushSelector             = get_option( 'APP_BANNERS_pushSelector' );
